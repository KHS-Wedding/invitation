(() => {
  ...
  function renderVenueInfoStrip(venue) {
    return `
      <div class="venue-info-strip reveal">
        <div class="venue-info-item">
          <span class="venue-info-icon" aria-hidden="true">⌖</span>
          <div>
            <strong>주소</strong>
        ...
        ${venue.phone ? `
          <a class="venue-info-item venue-info-link" href="tel:${escapeHtml(venue.phone.replaceAll('-', ''))}">
            <span class="venue-info-icon" aria-hidden="true">☎</span>
            <div>
              <strong>호텔 ICC 대표번호</strong>
              <p>${escapeHtml(venue.phone)}</p>
            </div>
          </a>` : ''}
        <a class="venue-info-item venue-info-link" href="${safeUrl(venue.naver_place_url)}" target="_blank" rel="noopener">
          <span class="venue-info-icon" aria-hidden="true">🚗</span>
          <div>
            <strong>내비게이션</strong>
            <p>호텔 ICC 검색</p>
