...
WEDDING = {
    'site': {
        ...
        # 링크 미리보기 캐시를 새로 불러오기 위한 공유 전용 주소입니다.
        'share_url': 'https://khs-wedding.github.io/invitation/?v=6',
        # 커버사진 대신 사용할 텍스트형 공유 미리보기 이미지입니다.
        'share_image': 'static/share-preview-v5.png',
        'asset_version': '6',
